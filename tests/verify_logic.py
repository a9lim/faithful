...
async def test_store_and_backend():
    ...
    try:
        ...
        # response might be "..." if chain is too small, but it shouldn't crash
...
def test_chat_chunking():
    ...
    # Instantiate Chat
    # This might fail if Chat.__init__ does more than assign bot
    # Chat.__init__ does: self._pending = {}
    chat = Chat(mock_bot)
